...
/* Javascript Challenge: Candies (Introduction)
...
Example
• For n = 3 and m=10, the output should be candiesfn, m) - 9.
...
function candies(n,m){
    //m = no of children
    //n = no of  pieces of candy
    const temp = Math.floor(m / n) * n

    console.log(temp + " pieces of candy will be eaten by all the children.")
}
